...
var WeatherSDK = /** @class */ (function () {
    function WeatherSDK(api_key) {
        ...
        this.WeatherCache = new node_cache_1.default({ stdTTL: 600 });
    }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        cacheKey = "weather_".concat(city.toLowerCase());
                        cachedData = this.WeatherCache.get(cacheKey);
                        console.log(cachedData);
                        if (cachedData) {
                            console.log("From Cache ".concat(cachedData));
                    ...
                    case 2:
                        data = _a.sent();
                        this.WeatherCache.set(cacheKey, data.data);
